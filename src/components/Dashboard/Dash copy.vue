        ...
        <div class="side-content-wrap">
            <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                <ul class="navigation-left">
                    <li class="nav-item"><RouterLink class="nav-item-hold" to="dash"><i class="nav-icon i-Bar-Chart"></i><span class="nav-text">Bosh sahifa</span></RouterLink>
                    ...
                    <li class="nav-item"><RouterLink class="nav-item-hold" to="tovartip"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Tovar tip</span></RouterLink>
                        
                    </li>
                    <li class="nav-item"><RouterLink class="nav-item-hold" to="yetkazuvchi"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Yetkazuvchi</span></RouterLink>
                        
                    </li>
                    <li class="nav-item"><RouterLink class="nav-item-hold" to="sqlad"><i class="nav-icon i-File-Clipboard-File--Text"></i><span class="nav-text">Sqlad</span></RouterLink>
                        
                    </li>
                    <li class="nav-item"><RouterLink class="nav-item-hold" to="chiqim"><i class="nav-icon i-File-Clipboard-File--Text"></i><span class="nav-text">Chiqim</span></RouterLink>
                        
                    </li>
                    <li class="nav-item"><RouterLink class="nav-item-hold" to="foyda"><i class="nav-icon i-File-Horizontal-Text"></i><span class="nav-text">Foyda</span></RouterLink>
                        
                    </li>
                    <li class="nav-item"><RouterLink class="nav-item-hold" to="korsatma"><i class="nav-icon i-Administrator"></i><span class="nav-text">Ko'rsatma</span></RouterLink>
        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6" v-on:click="targolya">
                        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">

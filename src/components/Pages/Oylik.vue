  ...
  export default {
        ...
        methods: {
            ...
            Createoylik(){
                ...
                malumotish(resu){
                    this.id = resu;
                    var na = this.ishchila.find(e => { if (e.id === resu) return e });
                    this.name = na.name;
                    this.Oyliklar({
                        'method': 'post',
                        'url': 'oylikget',
                        ...
                        <table class="tabl scroltab">
                            ...
                            <tbody>
                                <tr v-for="item in ishchila" :key="item.id" class="tir">
                                    ...
                                    <td>
                                        <a class="text-primary mr-2" v-on:click="malumotish(item.id)">
                        ...
                        <tr>
                            ...
                            <th>Дата 
                                <form @submit.prevent="onSubmit">
                                    <input type="text" v-model="filtre" placeholder="2020-01">
                                </form>
                            </th>
                            <th>Комент</th>
                            <th>Итог</th>
